...
<body class="{{ $color }}">
    ...
    <script>
        var dataTableLang = {
            ...
            lengthMenu: "{{ __('Show') }} _MENU_ {{ __('entr') }}",
            zeroRecords: "{{ __('No data available in table.') }}",
            info: "{{ __('Showing') }} _START_ {{ __('to') }} _END_ {{ __('of') }} _TOTAL_ {{ __('entr') }}",
            infoEmpty: "{{ __('Showing 0 to 0 of 0 entr') }}",
            infoFiltered: "{{ __('(filtered from _MAX_ total eee)') }}",
            search: "{{ __('Sea:') }}",
            thousands: ",",
