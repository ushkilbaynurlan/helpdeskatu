...
<head>
    ...
    <title>
        <?php echo $__env->yieldContent('page-title'); ?><?php echo e(config('HELPDESK AUES')); ?>
...
<body class="<?php echo e($color); ?>">
    ...
    <script type="text/javascript">
        $('.show_confirm').click(function(event) {
            ...
            swal({
                    title: `Сенімдісіз бе?`,
                    text: "Жойылғаннан кейін қайтару мүмкін емес!",
                    icon: "warning",
                    buttons: ["Жоқ", "Иә"],
                    //   buttons: true,
                    dangerMode: true,
    ...
    <script>
        var date_picker_locale = {
            ...
            monthNames: [
                "<?php echo e(__('Қаңтар')); ?>",
                "<?php echo e(__('Ақпан')); ?>",
                "<?php echo e(__('Наурыз')); ?>",
                "<?php echo e(__('Сәуір')); ?>",
                "<?php echo e(__('Мамыр')); ?>",
                "<?php echo e(__('Маусым')); ?>",
                "<?php echo e(__('Шілде')); ?>",
                "<?php echo e(__('Тамыз')); ?>",
                "<?php echo e(__('Қыркүйек')); ?>",
                "<?php echo e(__('Қазан')); ?>",
                "<?php echo e(__('Қараша')); ?>",
                "<?php echo e(__('Желтоқсан')); ?>"
            ],
        };
        var calender_header = {
            today: "<?php echo e(__('бүгін')); ?>",
            month: '<?php echo e(__('ай')); ?>',
            week: '<?php echo e(__('апта')); ?>',
            day: '<?php echo e(__('күн')); ?>',
            list: '<?php echo e(__('тізім')); ?>'
        };
    </script>
    ...
    <script>
        var dataTableLang = {
            ...
            lengthMenu: "<?php echo e(__('Көрсету')); ?> _MENU_ <?php echo e(__('entries')); ?>",
            zeroRecords: "<?php echo e(__('Базада ақпарат жоқ.')); ?>",
            info: "<?php echo e(__('Көру')); ?> _START_ <?php echo e(__('to')); ?> _END_ <?php echo e(__('of')); ?> _TOTAL_ <?php echo e(__('entries')); ?>",
            infoEmpty: "<?php echo e(__('Showing 0 to 0 of 0 entries')); ?>",
            infoFiltered: "<?php echo e(__('(filtered from _MAX_ total entries)')); ?>",
            search: "<?php echo e(__('Іздеу:')); ?>",
            thousands: ",",
            loadingRecords: "<?php echo e(__('Жүктеу...')); ?>",
            processing: "<?php echo e(__('Жүктеу...')); ?>"
        }
    </script>
...
<?php /**PATH /Users/nurlan/HELPDESK/main_file/resources/views/layouts/admin.blade.php ENDPATH**/ ?>