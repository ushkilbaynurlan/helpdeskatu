                ...
                <div class="container-fluid pe-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('login')); ?>"><?php echo e(__('Агент')); ?></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('search')); ?>"><?php echo e(__('Тикетті іздеу')); ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-12 text-center">
                    ...
                    <div class="card">
                        <div class="card-body w-100">
                            <div class="">
                                <h4 class="text-primary mb-3"><?php echo e(__('Тикет құру')); ?></h4>
                            </div>
                    ...
                    <div class="chat d-none">
                        <div class="chat_header btn-primary dark_background_color">
                            <div class="chat_option">
                                ...
                                <span id="chat_head" class=""><?php echo e(__('Агент')); ?></span>
                            </div>
                        </div>
                        <div class="msg_chat">
                            <div id="chat_fullscreen" class="chat_conversion chat_converse">
                                <h3 class="text-center mt-5 pt-5"><?php echo e(__('Хабарлама табылмады.!')); ?></h3>
                            </div>
                            <div class="fab_field">
                                <textarea id="chatSend" name="chat_message" placeholder="<?php echo e(__('Хабарлама жіберу')); ?>"
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="chat_email"  name="name" placeholder="<?php echo e(__('Email енгізіңіз')); ?>"  autofocus>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row mb-4 ml-md-2">
                                        <div class="col-sm-12 col-md-7">
                                            <button class="btn-submit btn btn-primary btn-block" id="chat_frm_submit"
                                                type="button"><span><?php echo e(__('Чатты бастау')); ?></span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        ...
        if ($(".select2").length) {
            $('.select2').select2({
                "language": {
                    "noResults": function() {
                        return "<?php echo e(__('Результат жоқ')); ?>";
                    }
                },
            });
        }
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nurlan/HELPDESK/main_file/resources/views/home.blade.php ENDPATH**/ ?>