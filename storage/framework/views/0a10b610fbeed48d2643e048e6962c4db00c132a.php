                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="require form-label"><?php echo e(__('Тіркеу:')); ?>

                                        <small>(<?php echo e(__('документ немесе сурет')); ?>)</small> </label>
                                            ...
                                            <?php if(!empty($attachments)): ?>
                                                <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="list-group-item px-0 me-3 b-0">
                                                        <a download="" href="<?php echo e($logo.'tickets/' . $ticket->ticket_id . '/' . $attachment); ?>" class="btn btn-sm btn-primary d-inline-flex align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Жүктеу')); ?>">
                                                            <i class="ti ti-arrow-bar-to-down me-2"></i> <?php echo e($attachment); ?>

                                                        </a>
                                                        <a class="bg-danger ms-2 mx-3 btn btn-sm d-inline-flex align-items-center" title="<?php echo e(__('Жою')); ?>" onclick="(confirm('Сенімдісіз бе?')?(document.getElementById('user-form-<?php echo e($index); ?>').submit()):'');">
                            ...
                            <form method="post" action="<?php echo e(route('admin.conversion.store', $ticket->id)); ?>"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group file-group mb-5">
                                        <label class="require form-label"><?php echo e(__('Тіркеу')); ?></label>
                                        <label class="form-label"><small>(<?php echo e(__('Құжат немесе сурет')); ?>)</small></label>
                                        <div class="choose-file form-group">
                                            <label for="file" class="form-label d-block">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nurlan/HELPDESK/main_file/resources/views/admin/tickets/edit.blade.php ENDPATH**/ ?>