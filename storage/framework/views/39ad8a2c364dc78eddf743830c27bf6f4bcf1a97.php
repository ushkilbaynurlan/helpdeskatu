                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control <?php echo e((!empty($errors->first('subject')) ? 'is-invalid' : '')); ?>" type="text" name="subject" required="" placeholder="<?php echo e(__('Тақырып')); ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group col-md-6">
                                <label class="require form-label"><?php echo e(__('Тіркеу:')); ?> <small>(<?php echo e(__('документ немесе сурет')); ?>)</small> </label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nurlan/HELPDESK/main_file/resources/views/admin/tickets/create.blade.php ENDPATH**/ ?>