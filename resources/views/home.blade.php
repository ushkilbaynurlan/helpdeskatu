                ...
                <div class="container-fluid pe-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}">{{ __('Агент') }}</a>
                            </li>
                            <li class="nav-item">
                                @if ($setting['FAQ'] == 'on')
                            ...
                            <li class="nav-item">
                                @if ($setting['Knowlwdge_Base'] == 'on')
                                    <a class="nav-link" href="{{route('knowledge')}}">{{ __('Мақалалар') }}</a>
                                @endif
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('search') }}">{{ __('Тикетті іздеу') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-12 text-center">
                    ...
                    <div class="card">
                        <div class="card-body w-100">
                            <div class="">
                                <h4 class="text-primary mb-3">{{ __('Тикет құру') }}</h4>
                            </div>
                    ...
                    <div class="chat d-none">
                        <div class="chat_header btn-primary dark_background_color">
                            <div class="chat_option">
                                ...
                                <span id="chat_head" class="">{{ __('Агент') }}</span>
                            </div>
                        </div>
                        <div class="msg_chat">
                            <div id="chat_fullscreen" class="chat_conversion chat_converse">
                                <h3 class="text-center mt-5 pt-5">{{ __('Хабарлама табылмады.!') }}</h3>
                            </div>
                            <div class="fab_field">
                                <textarea id="chatSend" name="chat_message" placeholder="{{ __('Хабарлама жіберу') }}"
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="chat_email"  name="name" placeholder="{{ __('Email енгізіңіз') }}"  autofocus>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row mb-4 ml-md-2">
                                        <div class="col-sm-12 col-md-7">
                                            <button class="btn-submit btn btn-primary btn-block" id="chat_frm_submit"
                                                type="button"><span>{{ __('Чатты бастау') }}</span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
