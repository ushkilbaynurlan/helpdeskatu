                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control {{(!empty($errors->first('subject')) ? 'is-invalid' : '')}}" type="text" name="subject" required="" placeholder="{{ __('Тақырып') }}">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group col-md-6">
                                <label class="require form-label">{{ __('Тіркеу:') }} <small>({{__('документ немесе сурет')}})</small> </label>
            ...
            {{-- <div class="col-md-4 col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h6>{{ __('Тіркеу') }}<small class="d-block">({{__('Құжат немесе сурет жүктеуге болады')}})</small></h6>
                    </div>
                    <div class="card-body">
                        <div class="choose-file form-group">
